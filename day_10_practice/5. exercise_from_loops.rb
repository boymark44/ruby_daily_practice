...
appended_characters = "a"

while appended_characters.length <= 5
  puts appended_characters
...
def reverse_string(string)
  ...
  while current_index_from_the_rear >= first_index
    reversed_string << string[current_index_from_the_rear]
