...
# Hint: Using step method in a single-line block to print the even elements:
...
# Hint: Using the upto method in blocks to print the even elements:
  def increments_of_two
...
def increments_of_two
  # Define an even_num and set it into an empty string:
  even_num = ""
